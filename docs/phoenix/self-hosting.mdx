...
<CardGroup cols={2}>
  ...
  <Card title="Amazon Aurora/RDS" href="/docs/phoenix/self-hosting/configuration/using-amazon-aurora" icon="aws">
    AWS RDS IAM authentication
  </Card>
  <Card title="Azure Database" href="/docs/phoenix/self-hosting/configuration/using-azure-database" icon="microsoft">
    Azure AD managed identity auth
  </Card>
</CardGroup>
